...
const COMMON_EN = {
  ...
  'nav.menu': 'Menu',
  'nav.keramik': 'Ceramics &amp; Prices', 'nav.cafe': 'Café &amp; Bar', 'nav.kino': 'Cinema Night',
  ...
  'err.amount': 'Amount must be between CHF 25 and CHF 500.',
...
const COMMON_DE = { // DE-Texte, die nur in JS vorkommen
  ...
  'err.amount': 'Der Betrag muss zwischen CHF 25 und CHF 500 liegen.',
